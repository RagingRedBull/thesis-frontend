        ...
        if (detectorId) {
            axios
                ...
                .then((response) => {
                    ...
                    response.data.sensorLogSet.map((sensor) => sensor.name === "MQ5" && setMq5(sensor.temperature))
                    response.data.sensorLogSet.map((sensor) => sensor.name === "MQ7" && setMq7(sensor.temperature))
